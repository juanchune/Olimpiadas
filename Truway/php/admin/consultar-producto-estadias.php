            ...
            <form method="get" action="" class="form-filtros">
                <div class=filtros>
                    <select class="select-filtro" name="categoria">
                        <option value="" disabled selected>Seleccione un tipo de categoria</option>
                    ...
                    <select class="select-filtro" name="localidad">
                        <option value="" disabled selected>Seleccion una localidad</option>
                ...
                <article class="producto">
                    <div class="informacion-principal">
                        <div class="informacion">
                            ...
                            <span class="lbl-informacion">NOMBRE_HOTEL</span>
                            <span class="lbl-informacion">SERVICIOS</span>
                            <span class="lbl-informacion">CATEGORIA</span>
                        </div>
