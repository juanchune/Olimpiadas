...
$query = "SELECT * FROM `pedidos` WHERE pedidos.estado_facturacion = 1";
...
<main>
    <link rel="stylesheet" href="/Olimpiadas/Truway/css/ventas.css">
        ...
        <div class="seleccionar-tipo-venta">
            <a href="/Olimpiadas/Truway/php/admin/ventas-pagas.php" class="tipo-venta pagas">Pagas</a>
            <a href="/Olimpiadas/Truway/php/admin/ventas-pendientes.php" class="tipo-venta pendientes seleccionado">Pendientes de pago</a></span>
        </div>
