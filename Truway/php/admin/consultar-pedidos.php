    ...
    <section class="section-tabla-productos">
        ...
        <?php 
            while ($row = mysqli_fetch_assoc($pedidos_result)) {
                ...
                $pedidos_query = "SELECT * FROM pedidos WHERE id_pedido = '$id_pedido'";
                $pedidos_result = mysqli_query($conexion, $pedidos_query);
                $pedido = mysqli_fetch_assoc($pedidos_result);

                $detalle_query = "SELECT id_producto FROM detalle_pedido WHERE id_pedido = '$id_pedido'";
            ...
            <?php while ($detalle = mysqli_fetch_assoc($detalle_result)) {
