            ...
            <form method="get" action="" class="form-filtros">
                <div class=filtros>
                    ...
                    <select class="select-filtro" name="precio">
                        <option value="" disabled selected>Seleccion una dificultad</option>
                        <option value="baja" name="">Baja</option>
                        <option value="media" name="">Media</option>
                        <option value="alta" name="">Alta</option>
                    </select>
                </div>
                ...
                <article class="producto">
                    <div class="informacion-principal">
                        <div class="informacion">
                            ...
                            <span class="lbl-informacion">UBICACION_SALIDA</span>
                            <span class="lbl-informacion">GUIA</span>
