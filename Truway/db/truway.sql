...
ALTER TABLE `paquetes` MODIFY `id_paquete` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `detalle_paquete` MODIFY `id_detalle_paquete` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `estadias` MODIFY `id_estadia` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `excursiones` MODIFY `id_excursion` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `pasajes` MODIFY `id_pasaje` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `vehiculos` MODIFY `id_vehiculo` int(11) NOT NULL AUTO_INCREMENT;
